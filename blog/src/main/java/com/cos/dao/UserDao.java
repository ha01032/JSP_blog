...
public class UserDao {
	...
	public int findEmailCheckByUsername(String username) {
		final String SQL = "SELECT emailCheck FROM user WHERE username = ?";
		conn = DBConn.getConnection();
	...
	public int updateUserProfile(User user,String path) {

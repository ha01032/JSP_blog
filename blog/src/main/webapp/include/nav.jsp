			...
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container box_1620">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						...
						<c:if test="${!empty sessionScope.user}"><li class="nav-item"><a href="/blog/user/userprofileform.jsp"><img src="${sessionScope.user.userProfile}" style="border-radius:50px;" width="30px"/></a></li></c:if>							
						</ul>
					</div>
				</div>
			</nav>
